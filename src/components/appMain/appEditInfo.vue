...
<script>
  import { Row, Col, Button, Icon, Modal, Input, Form, FormItem, Select, Option, Message } from 'iview'
  ...
  export default {
    ...
    components: {
      Datetime, PopupPicker, appHeader, Row, Col, Button, Popup, Icon, Modal, Input, Form, FormItem, Select, Option, Message
    }
  }
</script>
